...
# Note: Advanced PFT analysis examples (examples 5 & 6) have been moved to advanced_pft_analysis.py
...
def main():
    ...
    parser.add_argument(
        "--examples",
        nargs="+",
        choices=["uwue", "tea", "perez", "compare", "all"],
        default=["all"],
    ...
    try:
        ...
        print("    python examples/basic_usage.py --examples uwue tea")
        print("  跳过实际数据处理 / Skip real data processing:")
        print("    python examples/basic_usage.py --skip-real-data")
        print("\n  高级PFT分析示例 / For advanced PFT analysis examples:")
        print("    python examples/advanced_pft_analysis.py")
        print("  Python API使用示例 / For Python API usage examples:")
        print("    python examples/python_api_usage.py")
